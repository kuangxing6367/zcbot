...
from plugins.livingmemory.core.base.constants import (
    FAKE_TOOL_CALL_ID_PREFIX,
    MEMORY_INJECTION_FOOTER,
    MEMORY_INJECTION_HEADER,
)
from plugins.livingmemory.core.event_handler_modules import (
    GroupCapture,
    MemoryRecall,
    MemoryReflection,
    MessageUtils,
...
class EventHandler:
    ...
    async def handle_session_reset(self, event: Any) -> None:
