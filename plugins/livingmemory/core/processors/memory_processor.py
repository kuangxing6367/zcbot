...
from plugins.livingmemory.core.models.conversation_models import Message
from plugins.livingmemory.core.models.memory_atom import MemoryAtom
from plugins.livingmemory.core.processors.atom_classifier import classify_atoms
...
class MemoryProcessor:
    ...
    def _get_current_llm_provider(self):
        """获取当前 LLM Provider - 适配目标框架，直接返回 None，使用 llm_api 调用"""
        return None
...
"""
    ...
    async def _build_system_prompt_with_persona(self, persona_id: str | None) -> str:
        """构建包含人格提示的 system_prompt - 适配：直接返回基础提示词"""
    ...
    async def _call_llm_with_retry(
        ...
        """
        带指数退避的 LLM 调用 - 适配目标框架，使用 llm_api
        ...
        Returns:
            LLM 响应文本
        """
        from plugins.livingmemory.core.core.llm_api import call_llm
