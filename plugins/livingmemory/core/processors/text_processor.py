...
from plugins.livingmemory.core.models.default_stopwords import DEFAULT_STOPWORDS as FALLBACK_STOPWORDS
...
class TextProcessor:
    ...
    async def async_init(self) -> None:
        ...
        if self.stopwords_dir:
            from plugins.livingmemory.core.utils.stopwords_manager import StopwordsManager
